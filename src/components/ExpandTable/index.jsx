...
export default function ExpandTable() {
  ...
  return <Card free className={styles.container}>
      <Card.Content>
        <Table.StickyLock {...tableProps} tableWidth={1000} hasBorder={false} primaryKey="email" expandedRowRender={record => <SubTable dataSource={[record.location]} />} openRowKeys={openRows} onRowOpen={keys => setOpenrows(keys)} expandedRowIndent={[0, 0]}>
